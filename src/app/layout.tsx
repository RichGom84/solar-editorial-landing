...
export const metadata: Metadata = {
  ...
  description:
    "전기요금 걱정 끝! 프리미엄 태양광 전문가가 상담부터 보조금 신청, 맞춤 설계, 시공, A/S까지 원스톱으로 도와드립니다. 지금 무료 상담 신청하세요.",
  alternates: {
    canonical: siteUrl,
  ...
  openGraph: {
    ...
    description:
      "전기요금 최대 80% 절감, 정부보조금 최대 200만원. 프리미엄 태양광 시공 전문 Solar Editorial에서 무료 상담받으세요.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "태양광 상담서비스 - Solar Editorial 프리미엄 태양광 설치",
      },
    ],
  },
  twitter: {
    ...
    title: "태양광 설치 무료 상담 | Solar Editorial",
    description:
      "전기요금 최대 80% 절감. 상담부터 보조금, 시공, A/S까지 원스톱 태양광 솔루션.",
